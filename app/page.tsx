...
if (showSplash) {
  return (
    <div className="fixed inset-0 bg-[#f9f8f5] flex flex-col items-center justify-center text-center px-4">
      <span className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-4 md:mb-6 animate-bounce">
        👋
      </span>

      <h1 className="font-serif font-bold text-[#2d6a1a] text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
